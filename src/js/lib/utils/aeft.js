...
const getLatestFile = (dir, suffix) => {
    const getModified = (filePath) => fs.statSync(filePath).mtime.valueOf();
    let latestFile = null;
    fs.readdirSync(dir)
...
export const getRenderSettingsList = () => {
    const prefsDir = getPrefsDir();
