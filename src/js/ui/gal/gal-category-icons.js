import { Aperture, Box, Film, Folder, Image, Layers, LayoutTemplate, MessageCircle, Monitor, Music2, Palette, Share2, Shapes, Smile, SplitSquareHorizontal, Type, } from "lucide-react";
import { ChartPieIcon, ContrastIcon, LayoutPanelTopIcon, MapPinIcon, MessageCircleCheckIcon, SquaresSubtractIcon, TimerIcon, ToggleRightIcon, TypeIcon, WebhookIcon, Y2kIcon, } from "./gal-local-category-icons";
const GAL_ROOT_ICONS = {
